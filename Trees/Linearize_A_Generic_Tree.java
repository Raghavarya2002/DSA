...
// this code is of O(n^2) complexity
...
public class Main {
  ...
  public static void linearize(Node node){
    ...
    Node secondlastc = node.children.get(node.children.size()-1);
    Node secondlastail = getTail(secondlastc);
    secondlastail.children.add(lastc);
    }
  }
